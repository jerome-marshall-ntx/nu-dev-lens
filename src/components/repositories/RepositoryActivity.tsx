import type { RepositoryCommit } from "@/data-access/repository";
                  ...
                  <div className="rounded-2xl glass-subtle p-3 transition-all duration-200 group-hover:glass">
                    <div className="flex items-start justify-between gap-2">
                      <div className="min-w-0 flex-1">
                        ...
                        {/* Contributor info */}
                        <Link
                          href={`/contributors/${commit.contributor.username}`}
                          className="mt-2 inline-flex items-center gap-2 rounded-md px-1 py-0.5 transition-colors hover:bg-primary/10"
                        >
                          <Image
                            src={commit.contributor.avatarUrl}
                            alt={`${commit.contributor.username}'s avatar`}
                            width={20}
                            height={20}
