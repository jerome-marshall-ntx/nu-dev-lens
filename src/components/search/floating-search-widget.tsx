  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "fixed right-6 bottom-6 z-50 flex items-center gap-3 rounded-full border border-zinc-200 bg-white px-3.5 py-2 text-foreground transition-all duration-300 focus:outline-none",
